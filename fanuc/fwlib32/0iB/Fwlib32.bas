...
' read program restart status
Declare Function cnc_rstrdstatus Lib "fwlib32.dll" (ByVal FlibHndl As Integer, ByBal a As Integer, ByVal b As Integer) As Integer
